...
export const DRUID_SIGNS: DruidSign[] = [
  {
    ...
    name: "Яблоня",
    emoji: "🍎",
    description: "Яблоня — символ любви, красоты и гармонии. Люди-Яблони отличаются мягкостью характера, добротой и стремлением к гармонии.",
    ranges: [
  ...
  },
  {
    ...
    name: "Ива",
    emoji: "🌿",
    description: "Ива символизирует чувствительность, мягкость и творческое начало. Люди-Ивы очень эмоциональны, обладают развитым воображением и тяготеют к искусству.",
    ranges: [
  ...
  },
  {
    ...
    name: "Дуб",
    emoji: "🌳",
    description: "Дуб — знак силы, стойкости и энергетики. Люди-Дубы надёжны, не боятся трудностей и способны вдохновлять окружающих.",
    ranges: [
