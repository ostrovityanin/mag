...
import { useCookieSubscriptionVerification } from '@/hooks/useCookieSubscriptionVerification';
...
export const CookieEntryPage: React.FC = () => {
  ...
  const { 
    ...
    isAllowed,
    missingChannels 
  } = useCookieSubscriptionVerification(webApp);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 flex items-center justify-center">
      <div className="text-center">
        <p className="text-orange-600">Перенаправление в приложение...</p>
      </div>
    </div>
  );
};
